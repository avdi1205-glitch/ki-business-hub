...
const PROTECTED_PREFIXES = ["/admin", "/api/internal-bots", "/api/contact-lead/status", "/api/newsletter-subscribers", "/create-article", "/editor"];
...
export const config = {
  matcher: ["/admin/:path*", "/api/internal-bots/:path*", "/api/contact-lead/status/:path*", "/api/newsletter-subscribers/:path*", "/create-article/:path*", "/editor/:path*"],
};
