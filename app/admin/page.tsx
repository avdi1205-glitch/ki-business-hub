  ...
  const skills = [
    {
      ...
      desc: "KI-gesteuerte Artikel-Generierung",
  ...
  return (
    <div style={{ background: "var(--background)", minHeight: "100vh" }}>
      ...
      <div style={{ background: "var(--background-elevated)", borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
        <div className="max-w-7xl mx-auto px-8 py-8">
          <div>
            ...
            <p style={{ color: "var(--text-light)" }}>Monetisierungs-Plattform mit 7 intelligenten Skills</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        {/* Recent Activity */}
        <div className="mt-12">
          <h2 className="text-2xl font-bold mb-6" style={{ color: "var(--text-dark)" }}>📊 Letzte Aktivität</h2>
