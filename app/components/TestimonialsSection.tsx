...
const testimonials = [
  {
    ...
    location: "Munchen",
    initial: "S",
    quote: "Ich konnte deutlich schneller Inhalte veroffentlichen und meine ersten Affiliate-Klicks sauber auswerten.",
  ...
  },
  {
    ...
    location: "Berlin",
    initial: "T",
    quote: "Der groste Vorteil ist fur mich die Zeitersparnis. Ideen, Inhalte und Struktur stehen viel schneller.",
  ...
  },
  {
    ...
    location: "Hamburg",
    initial: "J",
    quote: "Fur mich war wichtig, dass Content, Newsletter und Monetarisierung in einem klaren Ablauf zusammenpassen.",
  ...
  },
  {
    ...
    location: "Wien",
    initial: "M",
    quote: "Ich sehe schneller, welche Inhalte funktionieren und wo sich ein Upgrade fur mich wirklich lohnt.",
